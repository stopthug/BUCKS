        ...
        {ASSETS.map((asset) => {
          ...
          return (
            <button
              ...
              aria-pressed={active}
              className={cn(
                "glass-soft flex flex-col items-center gap-1 rounded-[1.05rem] px-1.5 py-2 text-center transition-all duration-200 sm:flex-row sm:justify-center sm:gap-2 sm:px-2 sm:py-2.5",
